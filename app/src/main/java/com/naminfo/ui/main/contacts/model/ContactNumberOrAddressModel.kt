...
class ContactNumberOrAddressModel
    ...
    // Display only the user/phone part; retain the full address for calling and identity.
    val displayNumber: String = if (isSip) address?.username.orEmpty() else displayedValue
